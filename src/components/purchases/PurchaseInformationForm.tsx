  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <SelectTrigger disabled={isReadOnlyTypeAndNumber}>
              <div className="flex items-center gap-2">
                ...
                <span className={typeConfig[purchaseType].color}>{typeConfig[purchaseType].label}</span>
              </div>
            </SelectTrigger>
            <SelectContent>
        ...
        {purchaseType === "shipment" && setTrackingNumber && setCarrier && setShippingDate && (
          <>
            ...
            <div className="space-y-2">
              ...
              <Input id="shippingDate" type="date" value={shippingDate} onChange={(e) => setShippingDate(e.target.value)} />
            </div>
          </>
        )}
        ...
        <div className="space-y-2">
          <Label htmlFor="status">Status</Label>
          <Input id="status" type="text" value="Pending" disabled className="bg-gray-300 text-black cursor-not-allowed" />
        </div>
