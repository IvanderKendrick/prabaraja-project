...
const NavItem = ({ icon, label, href, isActive }: NavItemProps) => (
  <Link
    to={href}
    className={`flex items-center gap-3 px-4 py-1.5 hover:bg-sidebar-accent hover:text-sidebar-accentForeground transition-colors duration-200 mx-2 rounded-[20px] ${
      isActive ? "bg-sidebar-active/20 p-[10px] text-sidebar-active" : ""
    }`}
  >
    {icon}
...
const SubMenu = ({ isOpen, children }: SubMenuProps) => {
  ...
  return (
    <div
      ...
      style={{ height: height ? `${height + 10}px` : "0px" }}
    >
      <div
        ref={contentRef}
...
export const Sidebar = () => {
  ...
  const [isPurchasesOpen, setIsPurchasesOpen] = useState(
    isPurchasesRelated(currentPath)
  );
  const [isAssetsOpen, setIsAssetsOpen] = useState(
    currentPath.startsWith("/assets")
  );

  // 🧱 Tambahkan state baru di bagian atas Sidebar component (bersama state lain)
  ...
  return (
    <div className="w-56 h-screen bg-sidebar-bg flex flex-col sticky left-0 top-0 overflow-auto hide-scrollbar">
      ...
      <div className="flex-1 py-4 space-y-1">
        ...
        <SubMenu isOpen={isPurchasesOpen}>
          <Link
            ...
            className={`block mx-4 rounded-[14px] px-4 py-1.5 text-sm transition-colors duration-200 ${
              currentPath.startsWith("/purchases/quotations")
                ? "bg-sidebar-active/20 text-sidebar-active"
                : "hover:bg-sidebar-accent hover:text-sidebar-accentForeground"
            }`}
          >
          ...
          <Link
            to="/purchases/offers"
            className={`block mx-4 rounded-[14px] px-4 py-1.5 text-sm transition-colors duration-200 ${
              currentPath.startsWith("/purchases/offers")
                ? "bg-sidebar-active/20 text-sidebar-active"
                : "hover:bg-sidebar-accent hover:text-sidebar-accentForeground"
            }`}
          >
          ...
          <Link
            ...
            className={`block mx-4 rounded-[14px] px-4 py-1.5 text-sm transition-colors duration-200 ${
              currentPath.startsWith("/purchases/requests")
                ? "bg-sidebar-active/20 text-sidebar-active"
                : "hover:bg-sidebar-accent hover:text-sidebar-accentForeground"
            }`}
          >
          ...
          <Link
            to="/purchases/orders"
            className={`block mx-4 rounded-[14px] px-4 py-1.5 text-sm transition-colors duration-200 ${
              currentPath.startsWith("/purchases/orders")
                ? "bg-sidebar-active/20 text-sidebar-active"
                : "hover:bg-sidebar-accent hover:text-sidebar-accentForeground"
            }`}
          >
          ...
          <Link
            ...
            className={`block mx-4 rounded-[14px] px-4 py-1.5 text-sm transition-colors duration-200 ${
              currentPath.startsWith("/purchases/shipments")
                ? "bg-sidebar-active/20 text-sidebar-active"
                : "hover:bg-sidebar-accent hover:text-sidebar-accentForeground"
            }`}
          >
          ...
          <Link
            ...
            className={`block mx-4 rounded-[14px] px-4 py-1.5 text-sm transition-colors duration-200 ${
              currentPath.startsWith("/purchases/invoices")
                ? "bg-sidebar-active/20 text-sidebar-active"
                : "hover:bg-sidebar-accent hover:text-sidebar-accentForeground"
            }`}
          >
          ...
          <Link
            to="/billing-summary"
            className={`block mx-4 rounded-[14px] px-4 py-1.5 text-sm transition-colors duration-200 ${
              currentPath.startsWith("/billing-summary")
                ? "bg-sidebar-active/20 text-sidebar-active"
                : "hover:bg-sidebar-accent hover:text-sidebar-accentForeground"
            }`}
          >
          ...
          <Link
            to="/approval"
            className={`block mx-4 rounded-[14px] px-4 py-1.5 text-sm transition-colors duration-200 ${
              currentPath.startsWith("/approval")
                ? "bg-sidebar-active/20 text-sidebar-active"
                : "hover:bg-sidebar-accent hover:text-sidebar-accentForeground"
            }`}
          >
        ...
        >
          <span className="flex items-center gap-3">
            <Box size={20} />
            {/* ganti icon sesuai kebutuhan, misal dari lucide-react */}
        ...
        <SubMenu isOpen={isInventoryOpen}>
          <Link
            to="/inventory/stock"
            className={`block mx-4 rounded-[14px] px-4 py-1.5 text-sm transition-colors duration-200 ${
              currentPath.startsWith("/inventory/stock")
                ? "bg-sidebar-active/20 text-sidebar-active"
                : "hover:bg-sidebar-accent hover:text-sidebar-accentForeground"
            }`}
          >
          ...
          <Link
            ...
            className={`block mx-4 rounded-[14px] px-4 py-1.5 text-sm transition-colors duration-200 ${
              currentPath.startsWith("/inventory/product")
                ? "bg-sidebar-active/20 text-sidebar-active"
                : "hover:bg-sidebar-accent hover:text-sidebar-accentForeground"
            }`}
          >
          ...
          <Link
            ...
            className={`block mx-4 rounded-[14px] px-4 py-1.5 text-sm transition-colors duration-200 ${
              currentPath.startsWith("/inventory/warehouses")
                ? "bg-sidebar-active/20 text-sidebar-active"
                : "hover:bg-sidebar-accent hover:text-sidebar-accentForeground"
            }`}
          >
        ...
        <SubMenu isOpen={isAssetsOpen}>
          <Link
            to="/assets/current"
            className={`block mx-4 rounded-[14px] px-4 py-1.5 text-sm transition-colors duration-200 ${
              currentPath.startsWith("/assets/current")
                ? "bg-sidebar-active/20 text-sidebar-active"
                : "hover:bg-sidebar-accent hover:text-sidebar-accentForeground"
            }`}
          >
          ...
          <Link
            to="/assets/sold"
            className={`block mx-4 rounded-[14px] px-4 py-1.5 text-sm transition-colors duration-200 ${
              currentPath.startsWith("/assets/sold")
                ? "bg-sidebar-active/20 text-sidebar-active"
                : "hover:bg-sidebar-accent hover:text-sidebar-accentForeground"
            }`}
          >
      ...
      <button
        ...
        className="flex items-center gap-3 px-4 py-3 text-sidebar-text hover:bg-sidebar-accent hover:text-sidebar-accentForeground transition-colors duration-200 mx-2 rounded-[20px] mb-4"
      >
