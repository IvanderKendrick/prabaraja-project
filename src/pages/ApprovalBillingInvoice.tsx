...
const ApprovalBillingInvoice = () => {
  const [refreshKey, setRefreshKey] = useState(0);
  const { handleApprove, handleReject, isLoading } = useApprovalActions('BILLING');
  ...
  return (
    <div className="flex h-screen w-full">
      ...
      <div className="flex-1 overflow-auto">
        <Header
          title="Approval Billing Invoice"
          description="Manage billing invoice approvals"
        />
        <div className="p-6">
          <ApprovalTableGeneric
            key={refreshKey}
            action="getApprovalBillingInvoice"
...
export default ApprovalBillingInvoice;
