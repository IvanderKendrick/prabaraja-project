...
const ApprovalShipment = () => {
  ...
  const { handleApprove, handleReject, isLoading } = useApprovalActions('SHIPMENT');
  ...
  return (
    <div className="flex h-screen w-full">
      ...
      <div className="flex-1 overflow-auto">
        <Header
          title="Approval Shipment"
          description="Manage shipment approvals"
        />
        <div className="p-6">
          <ApprovalTableGeneric
            key={refreshKey}
            action="getApprovalShipment"
